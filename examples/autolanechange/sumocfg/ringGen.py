#!/usr/bin/env python2
#
# Copyright (C) 2017-2025 Luca Terruzzi <luca.terruzzi@studenti.unitn.it>
# Copyright (C) 2017-2025 Riccardo Colombo <riccardo.colombo@studenti.unitn.it>
...
gen_string += """
<!--
// Copyright (C) 2019-2025 Michele Segata <segata@ccs-labs.org>
//
