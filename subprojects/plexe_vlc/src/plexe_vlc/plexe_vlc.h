...
// PLEXE_VLC_API macro. Allows us to use the same .h files for both building a .dll and linking against it
#if defined(PLEXE_VLC_EXPORT)
#define PLEXE_VLC_API OPP_DLLEXPORT
#elif defined(PLEXE_VLC_IMPORT)
#define PLEXE_VLC_API OPP_DLLIMPORT
#else
#define PLEXE_VLC_API
#endif
