...
"""
Runs Plexe CoopeRIS simulation in current directory
"""
...
def relpath(s):
    plexe_cooperis_root = os.path.join(os.path.dirname(os.path.realpath(__file__)), '..')
    return os.path.relpath(os.path.join(plexe_cooperis_root, s), '.')

parser = argparse.ArgumentParser('Run a Plexe CoopeRIS simulation')
